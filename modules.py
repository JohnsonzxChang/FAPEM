...
class PatchEmbedding(nn.Module):
    def __init__(self, d_model, patch_len, stride, padding, dropout):
        ...
        self.stride = stride
        self.padding_patch_layer = nn.ReplicationPad1d((0, padding)) # nn.ZeroPad1d((0, padding))
...
class PatchEmbeddingSimple(nn.Module):
    def __init__(self, d_model, patch_len, dropout):
        super(PatchEmbeddingSimple, self).__init__()
        # Patching
        # self.patch_len = patch_len
        # self.stride = stride
        # self.padding_patch_layer = nn.ReplicationPad1d((0, padding)) # nn.ZeroPad1d((0, padding))
...
class SSVEPConfigs:
    ...
    data_dir=r'/home/zhangxu/prj/ssvep_project/bench'
    data_t0=seq_len
    multiplex=1
    dataset='bench'
    init_t0=125+35
